...
public interface CarDao extends JpaRepository<Car, Long> {
    ...
    @Query(value = "SELECT * FROM car Inner Join car_brand on car.brand_id = car_brand.id WHERE model LIKE %:search% Or car_brand.brand_name LIKE %:search%", nativeQuery = true)
